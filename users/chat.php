...
$sql1="select * from login where usertype='secratary'";
$res1=mysqli_query($conn,$sql1);
$r1=mysqli_fetch_assoc($res1);
$_SESSION['reciever']=$r1['email'];
?>
...
<script src="js/modernizr.custom.97074"></script>
<style>
body {
  margin: 0 auto;
  max-width: 800px;
...
<h2 class="text-success text-center">Sparsham Chat with Secratary</h2>
