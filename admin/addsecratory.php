...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
		...
		<!-- main content start-->
		<div id="page-wrapper">
            <h3 class="text-center">Add Secratory</h3>
<form>
    <div class="col-md-12">
...
<label for="inputState" class="form-label" >Register as</label>
  <input type="text" class="form-control" aria-label="Default select example" id="usertype"  value="secratary" readonly>
