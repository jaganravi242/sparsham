...
<body class="cbp-spmenu-push">
 ...
 <form>
          <select class="form-control"  onchange="updatestatus(this.value,<?php echo $r['food_donation_id']?>)">
...
<script type="text/javascript">
    ...
    console.log(id)
    $.ajax({
        url:"foodstatuschange.php",
        method:"POST",
        data:{
            food_donation_status:status,
            food_donation_id:id
        },
