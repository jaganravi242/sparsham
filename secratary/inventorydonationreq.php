...
<body class="cbp-spmenu-push">
    ...
    <tbody>
         <?php
            ...
            $sql="select * from inventory_donation a,registration b where a.email=b.email";
           ...
           <tr>
      <th scope="row"><?php echo $r['donation_id']?></th>
 ...
 <form>
          <select class="form-control"  onchange="updatestatus(this.value,<?php echo $r['donation_id']?>)">
